...
NOTE: Uses ports: 8080, 27017, 8383-8398, 9229 (cognito-local), 1025/8025 (MailHog), 12111 (stripe-mock). Default post-login landing is **Discovery SPA** (8398); see `login.html`.
