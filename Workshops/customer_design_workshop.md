# Customer Design Workshop - MentorHub Design Workshop
...
The purpose of a big ideas exercise is to capture bold ideas about how to improve the customer experience. Focus on meaningful outcomes rather than implementation details. Quantity over polish — your ten weirdest ideas beat your one safest idea.

### Observe

Generate as many ideas as possible for wowing the customer. Include absurd or magical thinking.
...
```
Cat opens the dashboard on her phone and then sees one plain-English sentence about what her mentee learned this week
```
...
The purpose of this exercise is to map the **Customer User Journey** from first signup through off-boarding. Identify key stages, touchpoints, emotions, and opportunities to delight or reduce friction.
...
```
stage: Subscribe
customer-does: Chooses a plan and pays for mentee slots
touchpoints: Customer SPA checkout, payment provider
pain: Unclear what she is paying for
opportunity: One screen explains plan, price, and who it is for
```

Suggested stages to consider (add, remove, or rename as needed):
...
The purpose of this retrospective exercise is to celebrate our successes and identify opportunities for continuous improvement.
