...
**SRE / platform infrastructure docs** (CloudFormation plans, DEPENDENCY_MOVE, CodeArtifact as-built, platform diagrams, roadmap) live in **[mentorhub_cloudformation/docs/specifications](https://github.com/mentor-forge/mentorhub_cloudformation/tree/main/docs/specifications)**. See [Archive/README.md](./Archive/README.md) for the migration map.
